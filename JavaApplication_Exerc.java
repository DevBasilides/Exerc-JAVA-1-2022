...
public class JavaApplication_Exerc {
    ...
    public static void um(){
        // Cria um Scanner para ler o número digitado
        Scanner leitor = new Scanner(System.in);
        // Escreve a mesnagem abaixo
        System.out.println("Digite um numero");
        // Lê o número do Scanner leitor e pula uma linha
        String num = leitor.nextLine();
        // Ele 'fecha' o processamento desse bloco de código, liberando espaço para rodar o resto do código
        leitor.close();
        ...
        // Pega o 'num' digitado na posição unitária e subtrái do lenght (que retorna o valor contando apartir do 1) para obter o valor unitário
